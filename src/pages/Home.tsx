          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2">
              <div className="relative">
                <img 
                  src="Imagenes/grupo intelector blanco.png" 
                  alt="Cybersecurity" 
                  className="rounded-lg shadow-xl border-0"
                />
                <div className="absolute -bottom-4 -right-4 bg-green-800 p-4 rounded-lg shadow-lg animate-pulse border-2 border-gree">
